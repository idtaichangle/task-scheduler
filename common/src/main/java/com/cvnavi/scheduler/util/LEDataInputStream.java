 ...
 * Products [withheld] Victoria, BC Canada [withdrawn] tel: (250) 361-9093
 * mailto:roedyg@mindprod.com http://mindprod.com Version 1.0 1998 January 6 1.1
 * 1998 January 7 - officially implements DataInput 1.2 1998 January 9 - add
 * LERandomAccessFile 1.3 1998 August 27 - fix bug, readFully instead of read.
 * 1.4 1998 November 10 - add address and phone. 1.5 1999 October 8 - use
 * com.mindprod.ledatastream package name. 1.6 2005-06-13 - made readLine
 * deprecated Very similar to DataInputStream except it reads little-endian
 * instead of big-endian binary data. We can't extend DataInputStream directly
 * since it has only final methods, though DataInputStream itself is not final.
 * This forces us implement LEDataInputStream with a DataInputStream object, and
 * use wrapper methods.
 */
